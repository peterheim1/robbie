...
from phoenix_robot.task_setup import *#use standered setup for testing
...
class Patrol():
    def __init__(self):
        ...
        with STAY_HEALTHY:
            ...
            CHARGE_ROBOT = MonitorTask("CHARGE_ROBOT", "battery_status", Float32, self.battery_state)
            CHARGE_ROBOT_FAKE = ServiceTask("CHARGE_ROBOT_FAKE", "battery_simulator/set_battery_level", SetBatteryLevel, 100)
            ...
            RECHARGE.add_child(AUTODOCK)
            RECHARGE.add_child(CHARGE_ROBOT)
            RECHARGE.add_child(CHARGE_ROBOT_FAKE)
