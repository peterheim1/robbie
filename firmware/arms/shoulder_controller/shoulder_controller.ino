...
Right_Elbow_lift.attach(9);// need to set limits 0 80 for start
...
void Ser_print()
{
  ...
  Serial.print("\t");
  Serial.print(getFeedback(0));//current position
  Serial.print("\t");
...
void J4()
{
  ...
  if (Right_elbow_target < 100) Right_elbow_target = 100;
 Right_Elbow_lift.write(Right_elbow_target); 
}
/*
void J5()
