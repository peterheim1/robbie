...
class head_track():
    def __init__(self):
        ...
        self.trajectory.points.append(JointTrajectoryPoint(positions = [0, 0], velocities = [1, 1], time_from_start = rospy.Duration(0.0)))  
        ...
        while not rospy.is_shutdown():
            ...
            if self.last_tracking_seq == self.tracking_seq:
                ...
                self.trajectory.points.append(JointTrajectoryPoint(positions = [0, 0], velocities = [0, 0], time_from_start = rospy.Duration(0.0)))
            else:
