...
def setup_task_environment(self):
    ...
    room_locations = (('garge', self.waypoints[0]),
                      ...
                      ('bathroom', self.waypoints[5]),
                      ('dining_room', self.waypoints[6]),
                      ('tims_room', self.waypoints[7]),
    ...
    self.docking_station_pose = (Pose(Point(0.221, 0.617, 0.0), Quaternion(0.0, 0.0, -0.039, 0.999)))
...
def init_work_station_marker(self):
    ...
    self.work_station_marker_pub = rospy.Publisher('work_station_marker', Marker)
